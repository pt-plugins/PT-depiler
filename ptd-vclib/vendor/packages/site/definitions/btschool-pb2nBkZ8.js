...
const E = {
  ...
  legacyUrls: ["uggcf://cg.ogfpubby.arg/"],
  ...
  search: {
    ...
    selectors: {
      ...
      progress: {
        ...
        elementProcess: (e) => {
          const r = (e.getAttribute("style") || "").match(/width:([\s*\d.]+)%/);
          return r && r.length >= 2 ? parseFloat(r[1]) : 0;
        },
      },
      status: {
        text: o.unknown,
        ...
        case: {
          ".progress_seeding": o.seeding,
          ".progress_downloading": o.downloading,
          ".progress_completed": o.completed,
          ".progress_no_downloading": o.inactive,
        },
      },
      tags: [
  ...
  userInfo: {
    ...
    selectors: {
      ...
      seeding: {
        ...
        elementProcess: (e) => {
          const r = (e.textContent?.trim() || "").match(/\d+/);
          return r ? parseInt(r[0], 10) : 0;
        },
      },
      seedingSize: {
        selector: [
        ...
        elementProcess: (e) => {
          const r = (e.textContent?.trim() || "").match(/[\d.]+\s*[A-Za-z]+/);
          return r ? n(r[0]) : 0;
        },
      },
    },
    process: [
      ...a.userInfo.process.map((e) => ({
        ...e,
        requestConfig: { ...e.requestConfig, params: { ...(e.requestConfig?.params || {}), _: Date.now() } },
      })),
    ],
  },
  levelRequirements: [
