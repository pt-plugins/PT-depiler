...
const i = {
  ...
  G = {
    ...
    category: [
      { name: "类别", key: "filter_cat", options: o(i), cross: { mode: "appendQuote" } },
      {
        name: "优惠",
        key: "free",
    ...
    search: {
      ...
      selectors: {
        ...
        status: {
          ...
          text: a.unknown,
          case: {
            "i.torrent_icons.seeding": a.seeding,
            "i.torrent_icons.leeching": a.downloading,
            "i.icon_torrent_disk.grabbed": a.inactive,
          },
        },
      },
    },
