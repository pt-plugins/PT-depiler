...
import { G as e, T as a } from "../utils/filesize-D_1hx4u8.js";
import {
...
const f = {
  ...
  category: [
    ...
    { name: "中文字幕", key: "team", options: [{ name: "中文字幕", value: 1 }], cross: { mode: "append" } },
    {
      name: "原始语言",
      key: "medium",
      options: [
  ...
  levelRequirements: [
    {
      ...
      name: "User",
      privilege:
        "新用户的默认级别；可以在做种/下载/发布的时候选择匿名模式； 可以发送邀请；User 及以上用户封存账号后不会被删除。",
    },
    {
      id: 2,
      name: "Power User",
    ...
    { id: 3, name: "Elite User", interval: "P8W", downloaded: 120 * e, ratio: 1.55, seedingBonus: 8e4, privilege: "" },
    {
      id: 4,
      name: "Crazy User",
      interval: "P15W",
    ...
    { id: 101, name: "养老族", groupType: "vip", privilege: "退休后的管理组成员。" },
    {
      id: 200,
      name: "发布员",
      groupType: "manager",
    ...
    },
    {
      ...
      groupType: "manager",
      privilege:
        "可以查看管理组信箱、举报信箱；管理趣味盒内容、投票内容；可以编辑或删除任何发布的种子；可以管理候选；可以管理论坛帖子、用户评论；可以查看机密日志；可以删除任何字幕；可以管理日志中的代码、史册；可以查看用户的邀请记录；可以管理用户帐号的一般信息。不能管理友情链接、最近消息、论坛版块；不能将种子设为置顶或促销；不能删除账号。",
    },
