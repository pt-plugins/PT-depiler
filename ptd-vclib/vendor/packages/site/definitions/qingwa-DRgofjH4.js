import { m as l, t as v } from "../../../es-toolkit/toMerged-Be-qf92q.js";
import { K as d, bD as p } from "../index-COeZNva1.js";
import { G as u, T as n } from "../utils/filesize-D_1hx4u8.js";
import g, {
  CategoryIncldead as c,
  CategorySpstate as P,
  CategoryInclbookmarked as D,
  SchemaMetadata as i,
...
const f = [
    ...
    { id: 1, groupType: "user", name: "User", nameAka: ["蝌蚪"], privilege: "新用户的默认级别。" },
    {
      id: 2,
      groupType: "user",
      name: "Power User",
      ...
      alternative: [
        { seedingBonus: 4e4, ratio: 1, uploads: 50 },
        { seedingBonus: 4e4, ratio: [1, 4], downloaded: 150 * u },
      ],
    },
    {
      id: 3,
      ...
      alternative: [
        { seedingBonus: 7e4, ratio: 1, uploads: 120 },
        { seedingBonus: 8e4, ratio: [1, 4.5], downloaded: 300 * u },
      ],
    },
    {
      id: 4,
      ...
      alternative: [
        { seedingBonus: 9e4, ratio: 1, uploads: 200 },
        { seedingBonus: 16e4, ratio: [1, 5], downloaded: 1 * n },
      ],
    },
    {
      id: 5,
      ...
      alternative: [
        { seedingBonus: 15e4, ratio: 1, uploads: 300 },
        { seedingBonus: 32e4, ratio: [1, 5.5], downloaded: 2 * n },
      ],
    },
    {
      id: 6,
      ...
      alternative: [
        { seedingBonus: 2e5, ratio: 1, uploads: 500 },
        { seedingBonus: 64e4, ratio: [1, 6], downloaded: 4 * n },
      ],
    },
    {
      id: 7,
      ...
      alternative: [
        { seedingBonus: 28e4, ratio: 1, uploads: 650 },
        { seedingBonus: 128e4, ratio: [1, 6.5], downloaded: 8 * n },
      ],
    },
    {
      id: 8,
      ...
      privilege: "得到5个邀请名额。",
      alternative: [
        { seedingBonus: 4e5, ratio: 1, uploads: 800 },
        { seedingBonus: 256e4, ratio: [1, 7], downloaded: 16 * n },
      ],
    },
    {
      id: 99,
  ...
  A = [
    ...
    },
    {
      ...
      generateRequestConfig: (e) => {
        ...
        return (
          e.forEach((r) => {
            p(a, `requestConfig.params.tagid_${r}`, 1);
          }),
          a
        );
      },
    ...
    selectors: {
      bonus: {
        ...
        filters: [
          (e) => (
            (e = e.replace(/,/g, "")),
            /(蝌蚪|Karma Points).+?([\d.]+)/.test(e)
              ? ((e = e.match(/(蝌蚪|Karma Points).+?([\d.]+)/)[2]), parseFloat(e))
              : /[\d.]+/.test(e)
...
class _ extends g {
  async parseUserInfoForSeedingStatus(a) {
    const r = a.id,
      m = await this.requestUserSeedingPage(r);
    let o = { seeding: 0, seedingSize: 0 };
    if (m && m?.includes("<table")) {
      const t = d(m);
      ((o.seeding = this.getFieldData(t, { selector: "#total_count", filters: [{ name: "parseNumber" }] })),
        (o.seedingSize = this.getFieldData(t, { selector: ["#total_size"], filters: [{ name: "parseSize" }] })));
    }
    return ((a = l(a, o, (t, s) => (typeof s > "u" ? t : s))), a);
  }
}
export { _ as default, N as siteMetadata };
