...
import { S as a } from "../index-COeZNva1.js";
...
const i = {
  ...
  d = {
    ...
    search: {
      ...
      requestConfig: { url: "/p_torrent/video_list_t.php", params: { area: "name" } },
      selectors: {
        ...
        status: {
          ...
          case: {
            "div[style*='background: #bbbbbb']": r.inactive,
            "div[style*='background: #71af67']": r.seeding,
            "div[style*='background: #53c541']": r.downloading,
          },
        },
      },
    },
    searchEntry: {
      ...
      area_music: { name: "音乐", requestConfig: { url: "/p_music/music_list_t.php" }, enabled: !1 },
    },
    userInfo: {
      pickLast: ["id", "name"],
      process: [
        {
          ...
          selectors: {
            ...
            name: { selector: "a[href*='user_detail.php']:first" },
          },
        },
        {
          ...
          selectors: {
            ...
            joinTime: { selector: ["td.nowrap:contains('加入日期') + td"], filters: [{ name: "parseTime" }] },
            uploaded: {
              selector: ["a[href*='user_upload.php']:first"],
              filters: [
                (t) => {
                  const e = t.match(/(\d+(\.\d+)?\s*[A-Za-z]+)/);
                  return e ? s(e[0] + "B") : 0;
                },
              ],
            },
            ...
            bonus: { selector: ["td.nowrap:contains('魔力') + td"], filters: [{ name: "parseNumber" }] },
            seedingBonus: {
          ...
          selectors: {
            seedingSize: {
              ...
              elementProcess: (t) => {
                let e = 0;
                return (
                  a("tr[class^='tm_tr']", t).forEach((n) => {
                    const o = a("td:nth-child(4)", n)[0];
                    e += s((o?.innerText?.trim() ?? "0") + "B");
                  }),
                  e
                );
              },
        ...
        },
        {
          ...
          selectors: {
            uploads: { text: 0, selector: "#table_pager span.pager_current", filters: [{ name: "parseNumber" }] },
          },
        },
        {
          requestConfig: { url: "/p_bonus/bonus_hour.php" },
          selectors: {
            bonusPerHour: { selector: "tr:contains('合计时魔') > td:last", filters: [{ name: "parseNumber" }] },
          },
        },
      ],
    },
    levelRequirements: [
      { id: 1, name: "User", nameAka: ["新手"], privilege: "入站初始等级" },
      ...
      { id: 5, name: "Insane User", nameAka: ["狂热"], isKept: !0, privilege: "无" },
      { id: 6, name: "Veteran User", nameAka: ["资深"], isKept: !0, privilege: "无" },
      { id: 7, name: "Extreme User", nameAka: ["大师"], isKept: !0, privilege: "无" },
      { id: 8, name: "Ultimate User", nameAka: ["宗师"], isKept: !0, privilege: "无" },
      { id: 9, name: "Master User", nameAka: ["满级"], isKept: !0, privilege: "无" },
      { id: 10, name: "Star User", nameAka: ["星级"], isKept: !0, privilege: "无" },
      { id: 11, name: "God User", nameAka: ["神级"], isKept: !0, privilege: "无" },
    ],
  };
