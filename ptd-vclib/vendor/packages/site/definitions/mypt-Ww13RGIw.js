...
const W = {
  ...
  levelRequirements: [
    ...
    { id: 6, name: "Insane User", interval: "P25W", downloaded: "500GB", ratio: 2.55, privilege: "可以檢視普通日誌。" },
    {
      id: 7,
      name: "Veteran User",
      interval: "P40W",
    ...
    { id: 200, groupType: "manager", name: "養老族(Retiree)", privilege: "  退休后的管理組成員。" },
    {
      id: 201,
      groupType: "manager",
      name: "發布員(Uploader)",
    ...
    { id: 205, groupType: "manager", name: "主管(Staff Leader)", privilege: "網站主管，可以做任何事。" },
  ],
};
