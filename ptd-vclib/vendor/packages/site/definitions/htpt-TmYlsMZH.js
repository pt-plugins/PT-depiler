...
const b = {
  ...
  userInfo: {
    ...e.userInfo,
    process: [
      ...e.userInfo.process.filter((a) => a.requestConfig.url !== "/mybonus.php"),
      { requestConfig: { url: "/mybonus_new.php", responseType: "document" }, fields: ["bonusPerHour"] },
    ],
  },
  levelRequirements: [
    { id: 0, name: "User", privilege: "新用户的默认级别" },
    { id: 1, name: "Power User", interval: "P4W", downloaded: "50GB", ratio: 1.05, privilege: "得到一个邀请名额。" },
    {
      id: 2,
      name: "Elite User",
      interval: "P8W",
    ...
    { id: 3, name: "Crazy User", interval: "P15W", downloaded: "300GB", ratio: 2.05, privilege: "得到一个邀请名额。" },
    { id: 4, name: "Insane User", interval: "P25W", downloaded: "500GB", ratio: 2.55, privilege: "得到一个邀请名额。" },
    {
      id: 5,
      name: "Veteran User",
      interval: "P40W",
