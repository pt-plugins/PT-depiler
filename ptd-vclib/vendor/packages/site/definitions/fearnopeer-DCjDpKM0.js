...
import { b as o, a as m } from "../utils/helper-OCngMtkv.js";
...
const i = { 1: "Movie", 2: "TV", 3: "Music", 6: "Anime", 4: "Games", 5: "Apps", 9: "Sport", 11: "Assorted" },
  w = {
    ...e,
    id: "fearnopeer",
    version: 1,
    ...
    category: [
      ...
      },
      {
        ...
        generateRequestConfig: (n) => {
          ...
          return (
            n.forEach((a) => {
              a === "doubleup" || a === "featured" || a === "refundable" ? (r[a] = 1) : r.free.push(a);
            }),
    ...
    search: {
      ...
      selectors: {
        ...e.search.selectors,
        category: { selector: ":self", data: "categoryId", filters: [(n) => i[Number(n)]] },
      },
    },
    userInfo: {
      ...e.userInfo,
      selectors: {
        ...
        uploads: { ...e.userInfo.selectors.uploads, selector: "dl.profile-stats-list-2026:has(a[href*='/uploads'])" },
        joinTime: {
          ...e.userInfo.selectors.joinTime,
    ...
    levelRequirements: [
      { id: 1, name: "User", privilege: "新用户默认等级；下载队列10个，可以发布种子" },
      {
        id: 2,
        name: "PowerUser",
        uploaded: "1TiB",
