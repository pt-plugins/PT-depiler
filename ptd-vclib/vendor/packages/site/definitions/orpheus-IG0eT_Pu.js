import t, { SchemaMetadata as e } from "../schemas/GazelleJSONAPI-1mDVuO-b.js";
...
const T = {
  ...
  userInfo: {
    ...
    selectors: {
      ...
      seedingSize: { selector: ["table > tbody > tr > td:eq(1)"], filters: [{ name: "parseSize" }] },
    },
  },
  levelRequirements: [
    { id: 1, name: "User", privilege: "None. Standard class for all new members" },
    {
      id: 2,
      name: "Member",
      interval: "P1W",
...
class z extends t {
  async getSeedingSize(i, s = 0) {
    await this.sleepAction(this.metadata.userInfo?.requestDelay);
    const { data: a } = await this.request({ url: "/bonus.php?action=bprates", responseType: "document" });
    return this.getFieldsData(a, this.metadata.userInfo.selectors, ["seedingSize"]);
  }
}
export { z as default, T as siteMetadata };
