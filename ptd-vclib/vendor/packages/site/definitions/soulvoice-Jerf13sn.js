...
const w = {
  ...
  searchEntry: {
    ...
    area_special: { name: "阅听分区", requestConfig: { url: "/special.php" }, enabled: !1 },
  },
  levelRequirements: [
    {
      id: 1,
    ...
    { id: 9, name: "Ultimate User", interval: "P80W", downloaded: "1.5TB", ratio: 4.05, isKept: !0, privilege: "" },
    { id: 10, name: "Nexus Master", interval: "P100W", downloaded: "3TB", ratio: 4.55, isKept: !0, privilege: "" },
  ],
};
