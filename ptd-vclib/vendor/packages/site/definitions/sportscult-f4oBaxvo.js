...
import { S as o } from "../index-COeZNva1.js";
import { p as m } from "../utils/filesize-D_1hx4u8.js";
import { b as u } from "../utils/helper-OCngMtkv.js";
...
const n = {
  ...
  U = {
    ...
    category: [
      { name: "类别", key: "category", options: u(n) },
      {
        name: "种子状态",
        key: "active",
        options: [
    ...
    search: {
      ...
      requestConfig: {
        ...
        params: { page: "torrents", active: 0, order: "created", by: "desc" },
      },
      ...
      selectors: {
        ...
        title: { selector: "a[href^='index.php?page=torrent-details&id=']" },
        ...
        completed: { selector: "td:nth-child(8)", filters: [g] },
        time: { selector: "td:nth-child(5)", filters: [{ name: "parseTime", args: ["dd/MM/yyyy"] }] },
        category: {
          selector: "a[href^='index.php?page=torrents&category=']",
          attr: "href",
          filters: [{ name: "querystring", args: ["category"] }, (e) => n[Number(e)]],
        },
        tags: [
          { name: "Free", selector: "img[src='gold/gold.gif']" },
          { name: "50%", selector: "img[src='gold/silver.gif']" },
        ],
      },
    },
    ...
    userInfo: {
      ...
      process: [
        ...
        },
        {
          ...
          selectors: { bonusPerHour: { selector: "#mcol div.b-content > h3", filters: [{ name: "parseNumber" }] } },
        },
      ],
    },
    levelRequirements: [
...
class w extends p {
  async parseUserInfoForSeeding(t, r) {
    if (!(r instanceof Document)) return t;
    const a = o("#mcol div.b-content table.lista:eq(2) tbody tr:gt(1)", r),
      l = a.length,
      d = a.reduce((s, c) => {
        const i = o("td:eq(1)", c);
        return i.length < 1 ? s : s + m(i[0].textContent || "");
      }, 0);
    return ((t.seeding = l), (t.seedingSize = d), t);
  }
}
export { w as default, U as siteMetadata };
