...
const b = {
  ...
  userInfo: {
    ...
    process: [
      ...
      { requestConfig: { url: "/mybonus.php", responseType: "document" }, fields: ["bonusPerHour"] },
    ],
  },
  levelRequirements: [
    {
    ...
    { id: 200, groupType: "manager", name: "退休的魔法少女", privilege: "退休后的管理组成员。" },
    { id: 201, groupType: "manager", name: "魔法释放者", privilege: "专注的发布者。免除自动降级；" },
    {
      id: 202,
      groupType: "manager",
      name: "至高的魔法师",
    ...
    { id: 205, groupType: "manager", name: "首席魔法少女", privilege: "网站主管，可以做任何事。" },
  ],
};
class M extends r {
  async requestUserSeedingPage(a, n = "seeding") {
    const { data: u } = await this.request({ url: "/getusertorrentlistajax.php", params: { useruuid: a, type: n } });
    return u || null;
  }
}
export { M as default, b as siteMetadata };
