import { SchemaMetadata as a } from "../schemas/Unit3D-ChxolkI5.js";
...
const D = {
  ...
  category: [
    ...
    },
    {
      ...
      cross: { mode: "custom" },
      generateRequestConfig: (r) => {
        const n = { free: [] };
        return (
          r.forEach((e) => {
            e === "doubleup" || e === "featured" || e === "refundable" ? (n[e] = 1) : n.free.push(e);
          }),
  ...
  search: {
    ...
    selectors: {
      ...a.search.selectors,
      tags: [...a.search.selectors.tags, { name: "H&R", selector: "*", color: "red" }],
    },
  },
  levelRequirements: [
