  ...
  search: {
    ...
    selectors: {
      ...
      status: {
        ...
        case: {
          ".rowfollow[title='Downloading']": e.downloading,
          ".rowfollow[title='Seeding']": e.seeding,
          ".rowfollow[title='Stopped']": e.inactive,
          ".rowfollow[title='Completed']": e.completed,
        },
      },
      tags: [...o.search.selectors.tags, { name: "Excl.", selector: "td.embedded > a[title] > b > font[color='red']" }],
    },
  },
  levelRequirements: [
    { id: 1, name: "本科新生", privilege: "新用户的默认级别。" },
    {
      id: 2,
      name: "小小学士",
      interval: "P2W",
      ...
      ratio: 1.5,
      privilege:
        '可以直接发布种子；可以查看NFO文档；可以查看用户列表；可以请求续种；可以查看其它用户的种子历史(如果用户隐私等级未设置为"强")； 可以删除自己上传的字幕。',
    },
    {
      id: 3,
      name: "优秀硕士",
    ...
    { id: 5, name: "海归博后", interval: "P15W", downloaded: "300GB", ratio: 4.5, privilege: "可以查看普通日志。" },
    {
      id: 6,
      name: "大学讲师",
      interval: "P20W",
    ...
    { id: 8, name: "终身教授", interval: "P80W", downloaded: "900GB", ratio: 7.5, isKept: !0, privilege: "更加高级。" },
    { id: 9, name: "荣誉院士", interval: "P100W", downloaded: "1TB", ratio: 8.5, isKept: !0, privilege: "更加高级。" },
