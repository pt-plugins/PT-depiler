import p, {
  ...
  CategoryInclbookmarked as v,
} from "../schemas/NexusPHP-BNC4SlPA.js";
import { K as g } from "../index-COeZNva1.js";
...
const q = {
  ...
  userInfo: {
    ...
    selectors: {
      ...
      name: { selector: "#welcome_text > span.nowrap > a[href*='userdetails.php']" },
      bonus: {
  ...
  levelRequirements: [
    ...
    { id: 6, name: "Insane User", interval: "P25W", downloaded: "500GB", ratio: 2.55, privilege: "可以查看普通日志。" },
    {
      id: 7,
      name: "Veteran User",
      interval: "P40W",
...
class z extends p {
  async parseUserInfoForSeedingStatus(e) {
    const l = e.id,
      r = await this.requestUserSeedingPage(l);
    if (!r || !/<b>\d+<\/b>\s{0,3}(条记录|records|條記錄)/.test(r)) return super.parseUserInfoForSeedingStatus(e);
    const i = g(r);
    return (
      (e.seeding = this.getFieldData(i, { selector: "b:eq(0)", filters: [(t) => parseInt(t)] })),
      (e.seedingSize =
        this.getFieldData(i, {
          selector: "b:eq(0)",
          elementProcess: (t) => {
            const n = t.closest("div")?.textContent ?? "",
              o = (n.split("|")[1] ?? n).replace(/,/g, ""),
              m = o.search(/[\d.]/),
              s = m >= 0 ? o.slice(m).trim() : "";
            return s ? c(s) : 0;
          },
        }) ?? 0),
      e
...
export { z as default, q as siteMetadata };
