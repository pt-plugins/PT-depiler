...
const w = {
  ...
  levelRequirements: [
    ...
    { id: 2, groupType: "user", name: "User", nameAka: ["草塘结庐"], privilege: "新用户的默认级别。" },
    {
      id: 3,
      groupType: "user",
      name: "Power User",
    ...
    { id: 200, groupType: "manager", name: "Retiree", nameAka: ["养老族"], privilege: "退休后的管理组成员。" },
    {
      id: 201,
      groupType: "manager",
      name: "Uploader",
    ...
    { id: 205, groupType: "manager", name: "Staff Leader", nameAka: ["主管"], privilege: "网站主管，可以做任何事。" },
  ],
  category: [
    {
      name: "分类",
