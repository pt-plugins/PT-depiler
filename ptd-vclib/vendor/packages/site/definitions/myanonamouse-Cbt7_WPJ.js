const r = [
  ...
  t = ["seedUnsat", "seedHnr", "sSat", "upAct"],
  n = ["upAct", "upInact"],
  l = {
    id: "myanonamouse",
    version: 1,
    ...
    category: [
      ...
      { name: "子类别", key: "tor[cat]", options: r, cross: { mode: "brackets" } },
      {
        name: "种子类型",
        key: "tor[searchType]",
        options: [
    ...
    search: {
      ...
      selectors: {
        ...
        tags: [
          { name: "Free", selector: "free", color: "blue" },
          { name: "VIP", selector: "fl_vip", color: "yellow" },
          { name: "H&R", selector: "id", color: "red" },
        ],
      },
    },
    list: [
      {
        ...
        selectors: { rows: { selector: "tr[id]" }, ...s },
      },
      {
        urlPattern: [/\/stats\/top10Tor\.php(\?.*)?$/],
        mergeSearchSelectors: !1,
        selectors: { rows: { selector: "table.newTorTable > tbody > tr" }, ...s },
      },
    ],
    detail: {
      urlPattern: [/\/t\/\d+(\?.*)?$/],
    ...
    userInfo: {
      ...
      process: [
        {
          requestConfig: { url: "/jsonLoad.php?snatch_summary&notif", responseType: "json" },
          selectors: {
            id: { selector: "uid" },
            ...
            seeding: { selector: ":self", filters: [(o) => t.map((e) => o[e].count).reduce((e, a) => e + a, 0)] },
            seedingSize: {
              selector: ":self",
              filters: [(o) => t.map((e) => o[e].size ?? 0).reduce((e, a) => e + a, 0)],
            },
            uploads: { selector: ":self", filters: [(o) => n.map((e) => o[e].count).reduce((e, a) => e + a, 0)] },
            messageCount: { selector: "notifs", filters: [(o) => Object.values(o).reduce((e, a) => e + a, 0)] },
            lastAccessAt: { selector: "update", filters: [(o) => o * 1e3] },
          },
        },
        {
          ...
          selectors: {
            ...
            trueUploaded: { selector: "td.rowhead:contains('Real Uploaded') + td", filters: [{ name: "parseSize" }] },
            trueRatio: { selector: "td.rowhead:contains('Real share ratio') + td", filters: [{ name: "parseNumber" }] },
            bonusPerHour: {
              selector: "td.rowhead:contains('Points earning') + td",
              elementProcess: (o) => {
                if (!o || typeof o.innerText != "string") return 0;
                const e = o.innerText.match(/worth\s+([\d.]+)\s+per hour/);
                return !e || !e[1] ? 0 : parseFloat(e[1]);
              },
            },
          },
        },
