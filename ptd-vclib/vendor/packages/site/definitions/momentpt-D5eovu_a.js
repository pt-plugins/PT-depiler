...
import { userInfoWithInvitesInUserDetailsPage as r } from "./kunlun-CkdsklM5.js";
...
const K = {
  ...
  category: [
    { name: "搜索入口", key: "#url", options: [{ name: "种子区", value: "/torrents.php" }] },
    {
      name: "分类",
      key: "cat",
      options: [
  ...
  searchEntry: { area_normal: { name: "种子区", requestConfig: { url: "/torrents.php" } } },
  userInfo: r,
  levelRequirements: [
    {
      id: 0,
