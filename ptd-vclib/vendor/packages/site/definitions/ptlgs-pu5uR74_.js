...
const R = {
  ...
  levelRequirements: [
    { id: 1, name: "Peasant", privilege: "被降级的用户" },
    ...
    { id: 4, name: "Elite User", downloaded: "200GB", ratio: 1.2, seedingBonus: 5e4, privilege: "" },
    {
      id: 5,
      name: "Crazy User",
      downloaded: "500GB",
    ...
    { id: 6, name: "Insane User", downloaded: "1TB", ratio: 1.2, seedingBonus: 2e5, privilege: "可以查看普通日志。" },
    {
      id: 7,
      name: "Veteran User",
      downloaded: "2TB",
    ...
    { id: 100, groupType: "vip", name: "贵宾(VIP)", privilege: "" },
