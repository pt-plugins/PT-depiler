import { SchemaMetadata as t } from "../schemas/Unit3D-ChxolkI5.js";
...
const s = {
  ...
  R = {
    ...
    category: [
      { name: "类别", key: "categoryIds", options: n(s), cross: { mode: "brackets" } },
      {
        name: "规格",
        key: "typeIds",
        options: [
      ...
      },
      {
        ...
        generateRequestConfig: (e) => {
          ...
          return (
            e.forEach((r) => {
              r === "doubleup" || r === "featured" || r === "refundable" ? (a[r] = 1) : a.free.push(r);
            }),
    ...
    search: {
      ...t.search,
      requestConfig: { url: "/torrents", responseType: "document", params: { perPage: 25 } },
      selectors: {
        rows: { selector: "div.__torrents-item" },
        id: {
          selector: "div.torrent--info a[href*='/torrents/']",
          attr: "href",
          filters: [(e) => e.match(/\/torrents\/(\d+)/)[1]],
        },
        title: { selector: "div.torrent--info a[href*='/torrents/'] h2" },
        url: { selector: "div.torrent--info a[href*='/torrents/']", attr: "href" },
        link: { selector: "a[href*='/torrents/download/']", attr: "href" },
        time: { selector: "div.torrent--info time", attr: "datetime", filters: [{ name: "parseTime" }] },
        size: { selector: "ul.__torrent-stats li:has(i.fa-hdd) div.badge-group-content" },
        seeders: { selector: "ul.__torrent-stats a:has(i.fa-arrow-up) div.badge-group-content" },
        leechers: { selector: "ul.__torrent-stats a:has(i.fa-arrow-down) div.badge-group-content" },
      },
    },
    userInfo: {
      pickLast: ["name"],
      process: [
        {
          ...
          selectors: {
            name: { selector: "nav.__navbar-subnav a[href*='/u/'] strong" },
            uploaded: {
              selector: "ul.__navbar-stats a:has(i.fa-arrow-up) span",
              filters: [
                (e) => {
                  const a = e.match(/([\d.,]+\s*[A-Za-z]+)/);
                  return a ? a[1] : e;
                },
                { name: "parseSize" },
              ],
            ...
            ratio: { selector: "ul.__navbar-stats a:has(i.fa-percent) span", filters: [{ name: "parseNumber" }] },
            seeding: {
              selector: "ul.__navbar-stats a:has(i.fa-arrow-up) span",
              filters: [
                (e) => {
        ...
        {
          requestConfig: { url: "/u/$name$", responseType: "document" },
          assertion: { name: "url" },
          selectors: {
            levelName: { selector: ".__profile-badges span.badge:has(i.fa-user)" },
            joinTime: {
            ...
            bonus: {
              ...
              filters: [(e) => e.replace(/[^\d.]/g, ""), { name: "parseNumber" }],
            },
            seedingSize: {
