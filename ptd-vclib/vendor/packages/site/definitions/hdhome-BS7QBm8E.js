import { E as l } from "../types/torrent-BvvY2NbA.js";
import {
  SchemaMetadata as a,
  CategoryIncldead as s,
  CategorySpstate as u,
  CategoryInclbookmarked as t,
  subTitleRemoveExtraElement as i,
...
const v = { selector: ["> td:eq(8)"], filters: [(e) => (e === "-" ? 0 : parseFloat(e))] },
  p = {
    selector: ["> td:eq(8)"],
    filters: [
      (e) => {
        if (e === "-") return l.unknown;
        {
          const m = parseFloat(e);
          switch (!0) {
            case /Noseed|未做种/.test(e):
              return m >= 100 ? l.completed : l.inactive;
            case /Seeding|做种中/.test(e):
              return l.seeding;
            case /Leeching|下载中/.test(e):
  ...
  z = {
    ...
    category: [
      ...
      u,
      t,
      { name: "标签", key: "tag", options: c, cross: !1 },
    ],
    ...
    search: {
      ...
      selectors: {
        ...
        subTitle: {
          ...
          elementProcess: i(["span.tags"], !0),
        },
        progress: v,
        status: p,
        tags: [...a.search.selectors.tags, ...d],
      },
    },
    searchEntry: {
      area_torrent: { name: "种子区", requestConfig: { url: "/torrents.php" } },
      area_live: { name: "LIVE区", enabled: !1, requestConfig: { url: "/live.php" } },
    },
    userInfo: {
      ...a.userInfo,
      selectors: {
        ...
        bonusPerHour: {
          ...
          elementProcess: (e) => {
            if (!e) return 0;
            const m = e.querySelectorAll('div[align="center"]'),
              r = Array.from(m)
                .map((o) => o.textContent || o.innerText || "")
                .join(" "),
              n = String(r || "")
                .replace(/,/g, "")
                .match(/[\d.]+/g);
            return n
              ? n.length === 10
                ? parseFloat(n[0]) + parseFloat(n[5]) + parseFloat(n[8])
                : parseFloat(n[0])
              : 0;
          },
        },
      },
      donorConfig: { ...a.userInfo.donorConfig, bonusPerHourMultiplier: 1 },
    },
    levelRequirements: [
      { id: 1, name: "User", nameAka: ["临时演员"], privilege: "新用户的默认级别。" },
      {
        id: 2,
        name: "Power User",
        nameAka: ["跑龙套"],
...
export {
  c as allCustomTags,
  d as allTagSelectors,
  v as selectorSearchProgress,
  p as selectorSearchStatus,
  z as siteMetadata,
};
