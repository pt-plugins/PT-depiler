const e = {
  ...
  levelRequirements: [
    ...
    { id: 3, name: "Crazy User", interval: "P15W", downloaded: "1TB", ratio: 2.5, privilege: "可以进入邀请区。" },
    {
      id: 4,
      name: "Insane User",
      interval: "P20W",
    ...
    { id: 8, name: "Nexus Master", interval: "P50W", downloaded: "5TB", ratio: 8, privilege: "账号永久保存(无需挂起)" },
  ],
};
