...
export const siteMetadata: ISiteMetadata = {
  ...
  search: {
    ...
    selectors: {
      rows: {
        selector:
          "div.text > table, div.text_alt > table, div.tr_review > table, div.tr_inpro > table",
      },
      ...
      leechers: {
        ...
        elementProcess: (element: HTMLElement) =>
          element.childNodes[1].textContent || 0,
      },
      completed: {
  ...
  userInfo: {
    selectors: {
      ...
      uploaded: {
        selector: [
          "div.text:contains('上传量')",
          "div.text:contains('上傳量')",
          "div.text:contains('Uploaded')",
        ],
      },
      downloaded: {
        selector: [
          "div.text:contains('下载量')",
          "div.text:contains('下載量')",
          "div.text:contains('Downloaded')",
        ],
      },
      levelName: {
      ...
      bonus: {
        selector: [
          "div.text:contains('魅力值')",
          "div.text:contains('Karma'):contains('Points')",
        ],
      },
      messageCount: {
      ...
      joinTime: {
        selector: [
          "div.text:contains('加入日期')",
          "div.text:contains('Join'):contains('date')",
        ],
        filters: [
          (query: string) => {
