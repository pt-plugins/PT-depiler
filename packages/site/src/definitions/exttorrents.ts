...
import type { ISearchFilter, ISiteMetadata, ITorrent } from "../types";
  ...
  search: {
    ...
    selectors: {
      ...
      id: {
        ...
        attr: "href",
        filters: [(q: string) => q && q.match(/-(\d+)\/?$/)![1]],
      },
      ...
      link: {
        selector: "td:nth-child(1) div.float-right a.torrent-dwn",
        attr: "href",
      },
      ...
      category: {
        selector: "td:nth-child(1) div.related-posted a:last-of-type",
        attr: "href",
...
export default class Exttorrents extends BittorrentSite {
  ...
  override async getTorrentDownloadLink(torrent: ITorrent): Promise<string> {
    ...
    if (!link) {
      ...
      link = this.getFieldData(<Document>data, {
        selector: "a.download-btn:last-of-type",
        attr: "href",
      });
    }
