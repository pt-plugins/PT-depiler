...
export const siteMetadata: ISiteMetadata = {
  ...
  levelRequirements: [
    ...
    },
    {
      ...
      alternative: [{ seedingBonus: 50000, ratio: 2.0, interval: "P5W", downloaded: 200 * GB }],
    },
    {
      id: 4,
      groupType: "user",
      ...
      alternative: [{ seedingBonus: 100000, ratio: 3.0, interval: "P10W", downloaded: 500 * GB }],
    },
    {
      id: 5,
      groupType: "user",
      ...
      alternative: [{ seedingBonus: 200000, ratio: 4.0, interval: "P15W", downloaded: 800 * GB }],
    },
    {
      id: 6,
      groupType: "user",
      ...
      alternative: [{ seedingBonus: 500000, ratio: 5.0, interval: "P20W", downloaded: 1 * TB }],
    },
    {
      id: 7,
      groupType: "user",
      ...
      alternative: [{ seedingBonus: 750000, ratio: 6.0, interval: "P25W", downloaded: 1.5 * TB }],
    },
    {
      id: 8,
      groupType: "user",
      ...
      alternative: [{ seedingBonus: 1500000, ratio: 7.0, interval: "P30W", downloaded: 2 * TB }],
    },
    {
      id: 9,
      groupType: "user",
      name: "Ultimate User",
      privilege: `得到3个邀请名额。`,
      alternative: [{ seedingBonus: 2000000, ratio: 8.0, interval: "P40W", downloaded: 3 * TB }],
    },
    {
      id: 10,
      groupType: "user",
      name: "Nexus Master",
      privilege: `得到4个邀请名额。`,
      alternative: [{ seedingBonus: 3000000, ratio: 10.0, interval: "P60W", downloaded: 4 * TB }],
    },
    {
      id: 11,
      groupType: "vip",
