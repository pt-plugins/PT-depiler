/**
 * @JackettDefinitions https://github.com/Jackett/Jackett/blob/master/src/Jackett.Common/Definitions/freefarm.yml
 * @PTMDefinitions https://github.com/JustLookAtNow/pt_mate/blob/master/assets/sites/freefarm.json
 */
