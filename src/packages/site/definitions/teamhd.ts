...
export const siteMetadata: ISiteMetadata = {
  ...
  search: {
    ...
    selectors: {
      ...
      leechers: {
        selector: "td:nth-child(4)",
        filters: [(query: string) => query.split("|")[1]],
      },
      completed: {
      ...
      tags: [
        {
          name: "Free",
          selector: "a[href*='/details/id'][style='color:#f2b101']",
        },
        {
          name: "50%",
          selector: 'a[href^="/details/id"][style="color:#828b8b"]',
        },
      ],
    },
  },
  userInfo: {
    ...
    selectors: {
      ...
      joinTime: {
        selector:
          "#profile_right > table.inlay > tbody > tr:nth-child(1) > td:nth-child(2)",
        filters: [{ name: "parseTime" }],
      },
      levelName: {
        selector:
          "#profile_left > table > tbody > tr > td:nth-child(2) > p:nth-child(1) > u > span",
      },
      seeding: {
