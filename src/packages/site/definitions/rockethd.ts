/**
 * @PDSDefinitions https://github.com/mantou568/pre-dessert-sites/blob/main/site_config/sites/rocket_hd.json
 */
...
export const siteMetadata: ISiteMetadata = {
  ...
  search: {
    ...
    selectors: {
      ...
      rows: {
        // 站点新版 Unit3D 列表使用 data-table 样式（参考 PDS rocket_hd.json）
