/**
 * @JackettDefinitions https://github.com/Jackett/Jackett/blob/master/src/Jackett.Common/Definitions/dmhy.yml
 * @PDSDefinitions https://github.com/mantou568/pre-dessert-sites/blob/main/site_config/sites/bt_dmhy.json
 */
...
export const siteMetadata: ISiteMetadata = {
  ...
  aka: ["動漫花園", "DMHY"],
  description:
    "動漫花園資訊網是一個動漫愛好者交流的平台,提供最及時,最全面的動畫,漫畫,動漫音樂,動漫下載,BT,ED,動漫遊戲,資訊,分享,交流,讨论.",
  timezoneOffset: "+0800",

  type: "public",

  urls: ["https://share.dmhy.org/"],
  ...
  search: {
    ...
    selectors: {
      ...
      id: {
        ...
        attr: "href",
        filters: [(q: string) => q.match(/\/view\/(\d+)/)![1]],
      },
      ...
      time: { selector: "td:nth-child(1) span", filters: [{ name: "parseTime", args: ["yyyy/MM/dd HH:mm"] }] },
