...
export const siteMetadata: ISiteMetadata = {
  ...
  type: "public",
  description:
    "A torrent tracker specialising in content from East Asia, including anime, manga, music, adult videos and more.",
  ...
  search: {
    ...
    selectors: {
      rows: {
        selector: "div#content > div.table-responsive > table > tbody > tr",
      },
