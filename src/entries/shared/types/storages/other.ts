...
import type { IStoredUserInfo, TSearchSnapshotKey, TTorrentCollectionKey } from "./metadata.ts";
...
export type TCollectionTorrentsStorageSchema = Record<TTorrentCollectionKey, ITorrent>; // 用于存储收藏夹种子信息
