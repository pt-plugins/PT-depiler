...
<template>
  ...
  <template v-if="siteConfig.id"><!-- 此处确保对应站点config获取成功 -->
    <a :href="siteConfig.activateUrl || siteConfig.url" target="_blank" rel="noopener noreferrer nofollow" class="captionText">{{ siteConfig.name }}</a>
  </template>
</template>
