...
import {
  siteFavicons,
  type storedSearchSolution,
  useSiteStore,
} from "@/shared/store/site.ts";
...
const { modelValue: showDialog, solution } = useVModels(componentProps);
