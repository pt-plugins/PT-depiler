...
export const defaultSynologyDownloadStationConfig: DSTorrentClientConfig = {
...
export default class SynologyDownloadStation implements TorrentClient {
  ...
  readonly config: DSTorrentClientConfig;
...
// 强制要求填写用户名和密码
interface DSTorrentClientConfig extends TorrentClientConfig {
  username: string;
  password: string;
}
