...
export const siteMetadata: ISiteMetadata = {
  ...
  userInfo: {
    process: [
      {
        ...
        fields: ['id', 'name', 'messageCount', 'uploaded', 'downloaded', 'ratio', 'seeding', 'seedingSize', 'levelName']
      },
      {
    ...
    selectors: {
      id: { selector: "a[href*='userdetails.php?id=']:first", attr: 'href', filters: [{ name: 'querystring', args: ['id'] }] },
      ...
      uploaded: { selector: "td.statuslink span:contains('UL:'):first", elementProcess: nextTextSibling, filters: [{ name: 'parseSize' }] },
      downloaded: { selector: "td.statuslink span:contains('DL:'):first", elementProcess: nextTextSibling, filters: [{ name: 'parseSize' }] },
      ratio: {
      ...
      seedingSize: { text: -1 },
      levelName: { selector: "a[href*='userdetails.php?id='] + span:first", filters: [(query: string) => query.replace(/[()]/g, '')] },
      bonus: { text: 'N/A' },
      joinTime: {
